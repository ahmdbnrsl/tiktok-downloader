...
export default function() {
  return (
    <div className="w-full flex flex-col align-middle items-center">
      ...
      <Paragraph size="text-sm">This is a feature for downloading media in the form of TikTok slide photo, It's quite easy to use, you just need to paste the URL of the TikTok slide photo that you copied, then press the download button and wait for the results.</Paragraph>
    </div>
  )
}